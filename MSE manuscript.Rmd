...
The majority of MSEs did not explicitly document how the stages of the MSE process -- defined using the SDM framework -- were completed (Table \@ref(tab:explicit)).  The most documented stage was the alternative stage, while 3 of the 30 MSEs explicitly documented a tradeoff analysis and 2 of the 30 documented a management decision. One of the 30 documented either the roles of participants in the MSE process or that the results of the MSE were adopted.
